...
class LunaModel(nn.Module):
    def __init__(self, in_channels=1, conv_channels=8):
        ...
        self.head_linear = nn.Linear(1152, 2) # 1152 = channels * img_shape = 64 * (2 * 3 * 3)
    ...
    def forward(self, input_batch):
        ...
        return linear_output, self.head_activation(linear_output) # logits, softmax-produced probabilities
